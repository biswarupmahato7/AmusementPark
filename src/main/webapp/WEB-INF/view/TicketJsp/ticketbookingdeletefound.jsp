...
<body>
  ...
  <div class="container" style="margin-top: 20px;margin-bottom: 20px;padding: 20px;height: 300px;">
    <div class="row">
      <form:form action="/ticketbooking/deleteticketbookingprocess" method="put" modelAttribute="ticketbooking">

      <form:hidden path = "ticketBookingId" value = "${activity.activityId}" />

        <div class="form-group">
          <label for="bookingDate">BookingDate</label>
          <input type="text" disabled value = "${ticketbooking.bookingDate}"class="form-control" id="bokingdate"/>
        </div>

        <div class="form-group">
          <button class="btn btn-primary">Delete TicketBooking</button>
        </div>
