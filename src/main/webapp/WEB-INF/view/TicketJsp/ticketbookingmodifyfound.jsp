...
<body>
  ...
  <div class="container" style="margin-top: 20px;margin-bottom: 20px;padding: 20px;height: 300px;">
    <div class="row">
      <form:form action="/ticketbooking/modifyticketbookingprocess" method="post" modelAttribute="ticketbooking">
        
        <form:hidden path = "ticketBookingId" value = "${ticketbooking.ticketBookingId}" />
      
        <div class="form-group">
          <label for="bookingDate">BookingDate</label>
          <form:input path="bookingDate" value="${ticketbooking.bookingDate}" class="form-control" id="bookingDate"/>
        </div>

        <div class="form-group">
          <button class="btn btn-primary">Modify TicketBooking</button>
        </div>
