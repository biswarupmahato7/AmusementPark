...
<body>
  ...
  <header id="header">
    <div class="container d-flex align-items-center justify-content-between position-relative">
      ...
      <div class="logo">
        <h1 class="text-light"><a href="index.html"><span>Amusement Park</span></a></h1>
  ...
  <div class="container" style="margin-top: 20px;margin-bottom: 20px;padding: 20px;height: 300px;">
    <div class="row">
      <form:form action="/ticketbooking/fetchfordeleteticketbooking" method="post" modelAttribute="ticketbooking">
        <div class="form-group">
          <label for="ticketBookingId">TicketBooking ID</label>
          <form:input path="ticketBookingId" class="form-control" id="ticketBookingId"/>
        </div>


        <div class="form-group">
          <button class="btn btn-primary">Fetch TicketBooking</button>
        </div>
