...
<body>
  ...
  <div class="container" style="margin-top: 20px;margin-bottom: 20px;padding: 20px;height: 300px;">
    <div class="row">
      <form:form action="/activity/listactivity" method="get" modelAttribute="activity">
        
        <div class="form-group">
            <label for="activityid">Activity ID</label>
            <input type="text" disabled value="${activity.activityId}" class="form-control" id="activityid"/>
        </div>
        <div class="form-group">
          <label for="description">Description</label>
          <input type="text" disabled value="${activity.activityDesc}" class="form-control" id="description"/>
        </div>

        <div class="form-group">
          <label for="charges">Charges</label>
          <input type="text" disabled value="${activity.activityCharges}"  class="form-control" id="charges"/>
        </div>
        <div class="form-group">
