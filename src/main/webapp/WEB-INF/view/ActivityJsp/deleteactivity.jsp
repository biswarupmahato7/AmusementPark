...
<body>
        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Activity</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li><a href="#">Modify activity</a></li>
  ...
  <div class="container" style="margin-top: 20px;margin-bottom: 20px;padding: 20px;height: 300px;">
    <div class="row">
      <form:form action="/activity/fetchfordeleteactivity" method="post" modelAttribute="activity">
        ...
        <!-- <div class="form-group">
          ...
          <form:input path="activityCharges" class="form-control" id="charges"/>
        </div> -->
        <div class="form-group">
          <button class="btn btn-primary">Fetch activity</button>
        </div>
