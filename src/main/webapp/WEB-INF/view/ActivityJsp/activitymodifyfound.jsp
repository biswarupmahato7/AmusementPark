...
<body>
  ...
  <header id="header">
    <div class="container d-flex align-items-center justify-content-between position-relative">
      ...
      <div class="logo">
        <h1 class="text-light"><a href="index.html"><span>SnowPark</span></a></h1>
  ...
  <div class="container" style="margin-top: 20px;margin-bottom: 20px;padding: 20px;height: 300px;">
    <div class="row">
      <form:form action="/activity/modifyactivityprocess" method="post" modelAttribute="activity">
        
        <form:hidden path = "activityId" value = "${activity.activityId}" />
      
        <div class="form-group">
          <label for="description">Description</label>
          <form:input path="activityDesc" value="${activity.activityDesc}" class="form-control" id="description"/>
        </div>

        <div class="form-group">
          <label for="charges">Charges</label>
          <form:input path="activityCharges" value="${activity.activityCharges}"  class="form-control" id="charges"/>
        </div>
        <div class="form-group">
          <button class="btn btn-primary">Modify activity</button>
        </div>
